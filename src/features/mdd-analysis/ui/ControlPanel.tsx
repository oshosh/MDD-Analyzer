...
import { searchSymbolsAction } from '../actions/actions'
import {
  Select,
  SelectContent,
  SelectItem,
...
import type { Instrument, IntervalType } from '@entities/instrument'
import type { MddQueryInput } from '../schemas/schemas'
import { Calendar, BarChart3, ArrowRight } from 'lucide-react'
import { useSymbolDates } from '../queries/useSymbolDates'
